...
%     num_points_inner 
%                    - If constructing an annular array with contigous
...
%
% See also makeCartSphere, makeCartCircle, makeBowl
...
% exactly the same trajector, otherwise, just distribution them evenly
