function [p_axial, p_lateral, p_axial_complex] = focusedBowlONeil_new(radius, diameter, velocity, frequency, sound_speed, density, axial_position, lateral_position)
