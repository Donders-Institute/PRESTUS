% Comparison between the on-axis pressure from a focused bowl transducer
% simulated using k-Wave with the O'Neil solution. The answer converges
% with the density off the integration points used for the off-grid source.
%
