% Comparison between the on-axis pressure from a focused annular array
% transducer simulated using k-Wave with the O'Neil solution. The answer
% converges with the density off the integration points used for the
% off-grid source.
%
...
if run_model
    ...
    % save temp data
    save ex08_temp_data amp amp_on_axis x_vec y_vec;
