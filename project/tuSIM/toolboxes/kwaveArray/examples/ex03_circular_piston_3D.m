...
% simulated using k-Wave with the analytical expression from [1]. The
% answer converges with the density off the integration points used for the
% off-grid source.
%
...
lateral_size    = 22e-3;    % total grid size in the lateral dimension [m]
...
karray = kWaveArray('BLITolerance', 0.025, 'UpsamplingRate', 20);
