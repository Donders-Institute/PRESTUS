function show_positioning_plots(segmented_img_orig, t1_pixel_size, trans_pos_orig, focus_pos_orig, segmented_img_final, trans_pos_final, focus_pos_final, parameters, options)
%     arguments
%         segmented_img_orig (:,:,:) 
%         t1_pixel_size (1,1)
%         trans_pos_orig (1,3)
...
%         focus_pos_final (1,3)
%         parameters struct
%         options.output_plot_name {mustBeText}
%     end
    ...
    if options.output_plot_name ~= ""
    export_fig(options.output_plot_name, '-native');
    close;
    end
end