function [results_thermal] = thermal_analysis(parameters, results_heating, ...
    ...
    if exist('planimg') && isfield(planimg, 't1_header')
        ...
        [~, source_labels] = transducer_setup(...
            ...
            parameters.transducer(1).position.trans_pos, ...
            parameters.transducer(1).position.focus_pos, ...
            size(segmentation), ...
            grid.resolution_mm);
    else
    ...
    if ndims(results_heating.maxT) == 3
        ...
        slices = struct( ...
            'dim', {'x', 'y', 'z'}, ...
            'pos', {parameters.transducer(1).position.focus_pos(1), ...
            parameters.transducer(1).position.focus_pos(2), ...
            parameters.transducer(1).position.focus_pos(3)});
        ...
        for i = 1:numel(slices)
            ...
            output_plot_filename = fullfile(parameters.output_dir,...
                sprintf('sub-%03d_%s_maxT_%s_%s.png',...
