function [medium_masks, skull_edge, segmented_image_cropped, trans_pos_final, focus_pos_final, min_dims, max_dims, ...
    new_grid_dims, translation_matrix] = preproc_smooth_and_crop(segmented_img, bone_img,  voxel_size_mm, ...
   ...
   %% skull postprocessing
    ...
    transducer_bowl = transducer_setup(parameters.transducer(1), trans_pos_upsampled_grid, focus_pos_upsampled_grid, size(segmented_img), voxel_size_mm);
