...
% Skipping is controlled by confirm_overwriting so overwrite_files = 'always'
% forces re-registration and 'never' skips an existing file.
%
...
if confirm_overwriting(path_to_output_img, parameters)
