function [results, acoustic_isppa, acoustic_MI, acoustic_pressure, highlighted_pos] = ...
    ...
    if contains(parameters.simulation.medium, {'layered'; 'phantom'})
        ...
        if any(intracranial_mask(:))
            [results.max_MI_tc] = masked_max_3d(acoustic_MI, intracranial_mask);
        else
            results.max_MI_tc = NaN; % intracranial tissues not modelled
        end
        ...
        writetable(table(parameters.subject_id, results.max_Isppa, results.max_Isppa_after_exit_plane, ...
            ...
            results.max_MI_brain, results.max_MI_tc, Ix_brain, Iy_brain, Iz_brain, trans_pos, focus_pos, ...
            ...
            'max_MI_skin', 'max_MI_skull', 'max_MI_brain', 'max_MI_tc', ...
        ...
        if numel(parameters.grid.dims)==3
            ...
            for i = 1:numel(slices)
                ...
                output_plot = fullfile( ...
                    ...
                    sprintf('sub-%03d_%s_isppa_T%02d_%s_%s.png', ...
