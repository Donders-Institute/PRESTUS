...
arguments
    ...
    results.MI = max(acoustic_MI(:)); % global MI, mirrors the existing global Isppa/Psptp convention
    ...
    results.TIC = compute_tic(parameters, tr, results.Isppa);
    ...
    if contains(parameters.simulation.medium, {'layered'; 'phantom'})
        ...
        writetable(table(parameters.subject_id, freq_Hz, ...
            ...
            results.Psptp_brain, results.Psptp, results.Ptp_target, results.MI_skin, results.MI_skull, ...
            ...
            'ep_offset_mm', 'ep_focal_distance_mm', 'TIC'}), ...
        ...
        writetable(table(parameters.subject_id, freq_Hz, results.Isppa, results.Isppa_after_exit_plane, ...
            results.Psptp, results.MI, results.Ptp_target, real_focal_distance, trans_pos, focus_pos, ...
            results.Ipa_target, results.Ipa_target_radius, ...
            ep_offset_mm, ep_focal_distance_mm, results.TIC, ...
            'VariableNames', {'subject_id', 'freq_Hz', 'Isppa', 'Isppa_after_exitplane', ...
            'Psptp', 'MI', 'Ptp_target', 'real_focal_distance_mm', 'trans_pos_vox', 'focus_pos_vox', ...
            'Ipa_target', 'Ipa_target_radius', ...
            'ep_offset_mm', 'ep_focal_distance_mm', 'TIC'}), ...
        parameters.io.filename_table);
    end
