function [results, acoustic_isppa, acoustic_MI, acoustic_pressure, highlighted_pos] = ...
    ...
    if contains(parameters.simulation_medium, {'skull'; 'layered'; 'phantom'})
        ...
        writetable(table(parameters.subject_id, results.max_Isppa, results.max_Isppa_after_exit_plane, ...
            ...
            'VariableNames', { 'subject_id', 'max_Isppa_Wcm2', 'max_Isppa_after_exitplane_Wcm2', 'real_focal_distance_mm', ...
            'max_Isppa_skin_Wcm2', 'max_Isppa_skull_Wcm2', 'max_Isppa_brain_Wcm2', ...
            ...
            'isppa_at_target_Wcm2', 'avg_isppa_around_target_Wcm2', ...
        ...
        'VariableNames', {'subject_id','max_Isppa_Wcm2', 'max_Isppa_after_exitplane_Wcm2', 'max_pressure_Pa', 'real_focal_distance_mm', 'trans_pos_vox', 'focus_pos_vox', 'isppa_at_target_Wcm2', 'avg_isppa_around_target_Wcm2'}), ...
        parameters.filename_output_table);
    end
