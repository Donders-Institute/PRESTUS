        ...
        if numel(parameters.grid.dims)==3
            ...
            for i_slice = 1:numel(slices)
                ...
                output_plot = fullfile( ...
                    parameters.io.figures_acoustic_dir, ...
                    sprintf('sub-%03d_%s%s_intensity_%s%s.png', ...
            ...
            output_plot = fullfile(parameters.io.figures_acoustic_dir, ...
                sprintf('sub-%03d_%s%s_intensity%s.png', ...
                parameters.subject_id, ...
                parameters.simulation.medium, ...
                parameters.io.output_affix, ...
                trans_suffix));
