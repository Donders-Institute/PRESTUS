function profile_oneil_opt = recompute_oneil_solution(parameters, profile_oneil, profile_target, opt_phases, opt_velocity)
    ...
    p_axial_oneil_opt = focusedAnnulusONeil(...
        ...
        [parameters.transducer.annular.Elements_ID_mm; parameters.transducer.annular.Elements_OD_mm] / 1e3, ...
        repmat(opt_velocity, 1, parameters.transducer.annular.n_elements), ...
        [opt_phases], ...
        parameters.transducer.annular.source_freq_hz, ...
    ...
    hold off;
    xline(parameters.exp_FD_bowl, '--', 'DisplayName', 'Focal Point wrt Mid-Bowl');
