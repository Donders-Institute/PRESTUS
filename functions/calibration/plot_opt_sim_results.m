function plot_opt_sim_results(parameters, profile_target, profile_oneil, profile_oneil_opt, profile_sim, profile_sim_opt, min_err)
    ...
    % Get distance of profiles from bowl (shared between profiles)
    axial_position = profile_target.axial_distance_bowl;
    ...
    plot(axial_position, profile_oneil.axial_intensity, ...
        'LineWidth', 1, 'Color', [0.5 0.5 0.5], 'DisplayName', 'Original (Analytical))');
    plot(axial_position, profile_oneil_opt.axial_intensity, ...
    ...
    plot(axial_position, profile_sim_opt.axial_intensity, ...
