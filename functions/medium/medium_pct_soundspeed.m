...
switch algorithm
    ...
    case 'marsac'
        ...
        c_water       = medium.water.sound_speed;     % sound speed [m/s]
    ...
    case 'aubry'
        ...
        c_water = medium.water.sound_speed;
        c_bone = medium.skull.sound_speed;
    ...
    case 'none'
        ...
        sound_speed(skull_idx) = medium.skull.sound_speed;
