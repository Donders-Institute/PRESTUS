...
config.trans.(field_name_tran_1).prestus.transducer.annular.elem_n = 4; % number of virtual elements
config.trans.(field_name_tran_1).prestus.transducer.annular.elem_id_mm = [0, 32.9184, 46.1264, 56.0324]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_1).prestus.transducer.annular.elem_od_mm = [32.3596, 45.5676, 55.5244, 64.008]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_2).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_2).prestus.transducer.annular.elem_id_mm = [0    6.5764   13.1529   19.7293   26.3058, 32.6136   35.2535   37.8935   40.5334   43.1734]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_2).prestus.transducer.annular.elem_od_mm = [5.7744   12.3509   18.9273   25.5038   32.0802, 34.9316   37.5716   40.2115   42.8515   45.4914]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_3).prestus.transducer.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_3).prestus.transducer.annular.elem_id_mm = [0    6.5764   13.1529   19.7293   26.3058, 32.6136   35.2535   37.8935   40.5334   43.1734]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_3).prestus.transducer.annular.elem_od_mm = [5.7744   12.3509   18.9273   25.5038   32.0802, 34.9316   37.5716   40.2115   42.8515   45.4914]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_4).prestus.transducer.annular.elem_n = 4; % number of virtual elements
config.trans.(field_name_tran_4).prestus.transducer.annular.elem_id_mm = [0, 32.9184, 46.1264, 56.0324]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_4).prestus.transducer.annular.elem_od_mm = [32.3596, 45.5676, 55.5244, 64.008]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_5).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_5).prestus.transducer.annular.elem_id_mm = [0, 4.59969, 9.19937, 13.7991, 18.3987, 22.9984, 27.5981, 32.1978, 36.7975, 41.3972]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_5).prestus.transducer.annular.elem_od_mm = [4.09423, 8.69391, 13.2936, 17.8933, 22.493, 27.0927, 31.6923, 36.292, 40.8917, 45.4914]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_6).prestus.transducer.annular.elem_n = 4; % number of virtual elements
config.trans.(field_name_tran_6).prestus.transducer.annular.elem_id_mm = [0, 33.02, 46.228, 56.0832]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_6).prestus.transducer.annular.elem_od_mm = [32.512, 45.7708, 55.626, 64.008]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_7).prestus.transducer.annular.elem_n = 30; % number of virtual elements
config.trans.(field_name_tran_7).prestus.transducer.annular.elem_id_mm = [10, 13.7667, 17.5333, 22.3, 24.5667, 26.8333, 30, 31.7667, 33.5333, 36.3, 37.7667, 39.2333, 41.7, 43.0, 44.3, 46.5, 47.6667, 48.8333, 51, 52.0333, 53.0667, 55.1, 56.0667, 57.0333, 58.9, 59.8, 60.7, 62.5, 63.3333, 64.1667]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_7).prestus.transducer.annular.elem_od_mm = [13.7667, 17.5333, 21.3, 24.5667, 26.8333, 29.1, 31.7667, 33.5333, 35.3, 37.7667, 39.2333, 40.7, 43.0, 44.3, 45.6, 47.6667, 48.8333, 50, 52.0333, 53.0667, 54.1, 56.0667, 57.0333, 58, 59.8, 60.7, 61.6, 63.3333, 64.1667, 65]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_8).prestus.transducer.annular.elem_n = 30; % number of virtual elements
config.trans.(field_name_tran_8).prestus.transducer.annular.elem_id_mm = [10, 13.7667, 17.5333, 22.3, 24.5667, 26.8333, 30, 31.7667, 33.5333, 36.3, 37.7667, 39.2333, 41.7, 43.0, 44.3, 46.5, 47.6667, 48.8333, 51, 52.0333, 53.0667, 55.1, 56.0667, 57.0333, 58.9, 59.8, 60.7, 62.5, 63.3333, 64.1667]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_8).prestus.transducer.annular.elem_od_mm = [13.7667, 17.5333, 21.3, 24.5667, 26.8333, 29.1, 31.7667, 33.5333, 35.3, 37.7667, 39.2333, 40.7, 43.0, 44.3, 45.6, 47.6667, 48.8333, 50, 52.0333, 53.0667, 54.1, 56.0667, 57.0333, 58, 59.8, 60.7, 61.6, 63.3333, 64.1667, 65]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_9).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_9).prestus.transducer.annular.elem_id_mm = [10, 22.1, 29.8, 36.0, 41.4, 46.3, 50.7, 54.9, 58.7, 62.4]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_9).prestus.transducer.annular.elem_od_mm = [21.1, 28.8, 35.0, 40.4, 45.3, 49.7, 53.9, 57.8, 61.5, 65]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_10).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_10).prestus.transducer.annular.elem_id_mm = [10, 22.1, 29.8, 36.0, 41.4, 46.3, 50.7, 54.9, 58.7, 62.4]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_10).prestus.transducer.annular.elem_od_mm = [21.1, 28.8, 35.0, 40.4, 45.3, 49.7, 53.9, 57.8, 61.5, 65]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_11).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_11).prestus.transducer.annular.elem_id_mm = [10, 22.1, 29.8, 36.0, 41.4, 46.3, 50.7, 54.9, 58.7, 62.4]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_11).prestus.transducer.annular.elem_od_mm = [21.1, 28.8, 35.0, 40.4, 45.3, 49.7, 53.9, 57.8, 61.5, 65]; % Outer diameter of each element [mm]
...
config.trans.(field_name_tran_12).prestus.transducer.annular.elem_n = 10; % number of virtual elements
config.trans.(field_name_tran_12).prestus.transducer.annular.elem_id_mm = [10, 22.1, 29.8, 36.0, 41.4, 46.3, 50.7, 54.9, 58.7, 62.4]; % Inner diameter of each element [mm]
config.trans.(field_name_tran_12).prestus.transducer.annular.elem_od_mm = [21.1, 28.8, 35.0, 40.4, 45.3, 49.7, 53.9, 57.8, 61.5, 65]; % Outer diameter of each element [mm]
