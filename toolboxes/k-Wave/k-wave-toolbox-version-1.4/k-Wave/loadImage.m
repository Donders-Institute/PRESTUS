...
%     image is loaded, the colour channels are summed before scaling. If no
%     input is given for filename, a selection dialog is invoked.
%
% USAGE:
%     im = loadImage()
