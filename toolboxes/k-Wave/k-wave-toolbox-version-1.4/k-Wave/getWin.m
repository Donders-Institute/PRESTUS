...
if plot_win
    switch length(N)
        ...
        case 3
            ...
            subplot(2, 2, 1);
            imagesc(squeeze(win(:, :, round(N(3)/2))));
            axis image;
            xlabel('y');
            ylabel('x');
            title('x-y slice');
            ...
            subplot(2, 2, 2);
            imagesc(squeeze(win(:, round(N(2)/2), :)));
            axis image;
            title('x-z slice');
            xlabel('z');
            ylabel('x');
            ...
            subplot(2, 2, 3)
            imagesc(squeeze(win(round(N(1)/2), :, :)));
            axis image;
            title('y-z slice');
            xlabel('z');
            ylabel('y');
            
            if exist('sgtitle') %#ok<EXIST>
            	sgtitle([num2str(N(1)) ' \times ' num2str(N(2)) ' \times ' num2str(N(3)) ' sample ' type ' window']);
            end
    end
end
