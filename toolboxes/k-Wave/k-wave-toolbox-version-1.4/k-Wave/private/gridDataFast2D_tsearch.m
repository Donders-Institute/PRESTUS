...
% DESCRIPTION:
%     Stripped down version of GRIDDATA that removes inbuilt data checking
%     and allows input and output of the delaunay triangulation for use on
%     subsequent calls with the exact same set of data coordinates.
%
% USAGE:
