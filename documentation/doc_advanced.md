...
A general strategy toward such parameter iteration is to work on the basus of a single study setup configuration (as described in the [starting guide](doc_getting-started.md)), whose values are iteratively overwritten in a MATLAB script. 
