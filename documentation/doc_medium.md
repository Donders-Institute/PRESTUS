...
The following default medium properties applt in a full layered simulation. Parameters are specified in the default_config.yaml file (see doc_config.md). While PRESTUS’s default parameters are chosen to align with commercially available tools and prior benchmarks, these should not be regarded as ground truths, and may need to be adjusted according to the goals at hand (e.g., a more conservative assessment of intensity and/or heating).
