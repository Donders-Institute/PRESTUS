...
for i = 1:N_i
    ...
    parameters.transducer.elem_phase_deg = zeros(1, tran.prestus.transducer.elem_n); % initial phases
    parameters.transducer.elem_amp = repmat(200000, 1, tran.prestus.transducer.elem_n); % initial amplitude
    ...
    for j = 1:N_j
        ...
        parameters.focal_distance_ep = focal_distance_ep;
        ...
        parameters.transducer.elem_phase_deg = elem_phase_deg; clear elem_phase_deg;
        ...
        for k = 1:N_k
            ...
            if isfield(parameters.calibration, 'add_FDO') && parameters.calibration.add_FDO == 1
                dist_bowl_exit_plane = parameters.transducer.annular.curv_radius_mm - parameters.transducer.annular.dist_geom_ep_mm;
            else
            ...
            parameters.focal_distance_ep = focal_distance_ep;
            parameters.focal_distance_bowl = focal_distance_ep + dist_bowl_exit_plane;
